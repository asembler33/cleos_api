        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="true">
                        <li><a href="javascript: void(0);" data-key="t-level-1-1">@lang('translation.conf_general')</a></li>
                        <li><a href="javascript: void(0);" data-key="t-level-1-2">@lang('translation.sucursales')</a></li>
                        <li><a href="javascript: void(0);" data-key="t-level-1-2">@lang('translation.roles')</a></li>
                        <li><a href="javascript: void(0);" data-key="t-level-1-2">@lang('translation.listado_servicios')</a></li>
                    </ul>
                </li>
