        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="true">
                        <li><a href="javascript: void(0);" data-key="t-level-1-1"><?php echo app('translator')->get('translation.conf_general'); ?></a></li>
                        <li><a href="javascript: void(0);" data-key="t-level-1-2"><?php echo app('translator')->get('translation.sucursales'); ?></a></li>
                        <li><a href="javascript: void(0);" data-key="t-level-1-2"><?php echo app('translator')->get('translation.roles'); ?></a></li>
                        <li><a href="javascript: void(0);" data-key="t-level-1-2"><?php echo app('translator')->get('translation.listado_servicios'); ?></a></li>
                    </ul>
                </li>
...
<!-- Left Sidebar End -->
<?php /**PATH F:\wamp64\www\cleos_laravel\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>