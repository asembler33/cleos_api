...
<script src="<?php echo e(URL::asset('assets/js/servicios/servicios.js')); ?>"></script>
<script src="<?php echo e(URL::asset('assets/js/especialidades/especialidades.js')); ?>"></script>
<script src="<?php echo e(URL::asset('assets/js/sucursales/sucursales.js')); ?>"></script>
<!-- pace js -->
<?php echo $__env->yieldContent('script'); ?>
<?php echo $__env->yieldContent('script-bottom'); ?>

<?php /**PATH F:\wamp64\www\cleos_api\resources\views/layouts/vendor-scripts.blade.php ENDPATH**/ ?>