                ...
                <div class="row justify-content-start">
                    <div class="col-md-2">
                        <!-- <div class="mb-3"> -->
                            ...
                            <button name="btnGuardarServicio" id="btnGuardarServicio" class="btn btn-primary">Guardar</button>
                            <button name="btnVolverServicio" id="btnVolverServicio" class="btn btn-danger">Volver</button>
                        <!-- </div> -->
                    </div>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\wamp64\www\cleos_laravel\resources\views/especialidades/crear-especialidad.blade.php ENDPATH**/ ?>